...
/**
 * Registration Page - Dark themed, glassmorphic design
 */
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-bloomberg flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <motion.div
        className="absolute top-20 left-10 w-72 h-72 rounded-full bg-bull/10 blur-3xl"
        animate={{ x: [0, 50, 0], y: [0, 30, 0] }}
        transition={{ duration: 8, repeat: Infinity }}
      />
      <motion.div
        className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-trust/10 blur-3xl"
        ...
        <div className="glass-card p-8 space-y-6 rounded-2xl border-2 border-white/10">
          ...
          >
            <motion.div
              ...
              className="p-3 rounded-full bg-bull/20 border border-bull/30"
            >
              <User size={28} className="text-bull" />
            </motion.div>

            <h1 className="text-3xl font-bold text-slate-100">Create Account</h1>
            <p className="text-sm text-slate-400">
              Join KMI-30 Alpha • Institutional Terminal
            </p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            >
              ...
              <input
                ...
                className={`
                  w-full glass-input
                  ${errors.name ? 'ring-2 ring-bear' : 'ring-0'}
                `}
              />
              {errors.name && (
            ...
            >
              ...
              <input
                ...
                className={`
                  w-full glass-input
                  ${errors.confirmPassword ? 'ring-2 ring-bear' : 'ring-0'}
                `}
              />
              ...
              className={`
                ...
                ${
                  isSubmitting
                    ...
                    : 'bg-gradient-to-r from-bull via-emerald-500 to-bull hover:shadow-glow-bull text-white'
                }
              `}
            >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-slate-900/50 text-slate-400">Already have an account?</span>
            </div>
          </div>
          ...
          >
            By registering, you agree to our Terms of Service. Your data is encrypted and secured.
          </motion.p>
        </div>
